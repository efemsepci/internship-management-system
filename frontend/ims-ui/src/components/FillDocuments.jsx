...
const FillDocuments = () => {
  const [formData, setFormData] = useState({
    stdName: "Default Name",
    stdSurname: "Default Surname",
    stdId: "123456",
    phoneNumber: "123-456-7890",
    birthPlaceDate: "Default Place, YYYY-MM-DD",
    ...
    internDepartment: "Default Department",
    startDate: "",
    endDate: "",
    internshipDays: "",
    ...
    personnelNumber: "0",
    departmentPersonnelNumber: "0",
    departmentCENGNumber: "0",
    internAdvisorFullName: "Default Advisor",
    internAdvisorPhone: "123-456-7890",
    internAdvisorJob: "Advisor",
    internAdvisorMail: "advisor@example.com",
    internshipTopic: "Default Topic",
    ...
    while (startDate <= endDate) {
      ...
      if (dayOfWeek !== 0 && dayOfWeek !== 6) {
        const isHoliday = holidayDates.some(
          (holiday) =>
            startDate >= holiday.startDate && startDate <= holiday.endDate
        );
  ...
  const handleSubmit = async (e) => {
    ...
    if (calculatedWorkDays < 20) {
      alert(
        "The work days between the start date and end date must be at least 20 days!"
      );
      return;
    }
    ...
    try {
      ...
      console.log(
        "Submission data sent successfully:",
      ...
      <form onSubmit={handleSubmit} className="custom-form">
        ...
        <div className="form-group">
          ...
          >
            ...
            <option value="1">
              {currentYear} Yaz dönemi sonunda mezun olacağım
            </option>
            <option value="2">
              {currentYear} Güz dönemi sonunda mezun olacağım
            </option>
            <option value="3">
              {currentYear + 1} Bahar dönemi sonunda mezun olacağım
            </option>
            <option value="4">
              {currentYear + 1} Güz dönemi sonunda veya ilerki dönemlerde mezun
              olacağım
            </option>
        ...
        {[
          ...
          {
            label: "Department Personnel Number",
            name: "departmentPersonnelNumber",
            type: "number",
          },
          {
            label: "Department CENG Number",
            name: "departmentCENGNumber",
            type: "number",
          },
          {
            label: "Intern Advisor Full Name",
            name: "internAdvisorFullName",
            type: "text",
          },
          {
            label: "Intern Advisor Phone",
            name: "internAdvisorPhone",
            type: "tel",
          },
          {
            label: "Intern Advisor Mail",
            name: "internAdvisorMail",
            type: "email",
          },
          {
            label: "Intern Advisor Job",
